  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-tertiary uppercase tracking-tighter mb-2">ANAIS</h1>
        <p className="text-on-surface-variant mb-8 text-sm uppercase tracking-widest font-bold">Sign in to continue</p>
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-error uppercase tracking-tighter mb-4">Access Denied</h1>
        <p className="text-on-surface mb-6 text-sm leading-relaxed">
          <span className="text-error font-bold">{user?.email}</span> is not authorized to use this app.
        </p>
