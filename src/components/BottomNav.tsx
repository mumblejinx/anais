import { Flower, Database, Telescope, Target, Compass, Wind } from 'lucide-react';
...
export default function BottomNav({ currentTab, setTab }: BottomNavProps) {
  const tabs = [
    { id: 'oracle', label: 'CHAT', icon: Flower, color: '#c97cff' },
    { id: 'inner', label: 'JOURNAL', icon: Database, color: '#c97cff' },
    { id: 'seeker', label: 'PLACES', icon: Telescope, color: '#c97cff' },
    { id: 'sanctuary', label: 'GOALS', icon: Target, color: '#c97cff' },
    { id: 'compass', label: 'GUIDE', icon: Compass, color: '#c97cff' },
    { id: 'integrate', label: 'BREATHE', icon: Wind, color: '#ff6b6b' },
  ];
